...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        front_tracker = Tracker(dist_thresh=50,
        ...
        back_tracker = Tracker(dist_thresh=50,
                        max_frames_to_skip=10,
                        max_trace_length=6,
                        deletion_threshold=3,
                        confirmation_threshold=3,
        ...
        for sample_idx in range(len(demo_dataset)):
            ...
            front_bevmap = draw_predictions(front_bevmap, front_detections, tracker=front_tracker, distance=None)
            ...
            back_bevmap = draw_predictions(back_bevmap, back_detections, back_tracker, None)
