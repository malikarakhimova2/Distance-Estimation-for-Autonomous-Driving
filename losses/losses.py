...
class Compute_Loss(nn.Module):
    ...
    def forward(self, outputs, tg):
        ...
        #l_distance = self.l1_loss(outputs['distance'], tg['obj_mask'], tg['indices_center'], tg['distance'])


        total_loss = l_hm_cen * self.weight_hm_cen + \
                     l_cen_offset * self.weight_cenoff + \
                     l_dim * self.weight_dim + \
                     l_direction * self.weight_direction + \
                     l_z_coor * self.weight_z_coorS
